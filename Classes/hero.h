...
public:
    ...
    void wavingMovement(std::string itemName);                                  // 挥舞特效
    ...
    void pickUpItems(std::string Name, int Num = 1);                            // 拾取物品
    void additems();                                                            // 增加手持的物品
    void additems(Sprite* item,std::string Name);                               // 上一函数的辅助函数（重载）
